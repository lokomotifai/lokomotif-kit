...
- [`packages/eval` README](https://github.com/lokomotifai/lokomotif-kit/blob/main/packages/eval/README.md) — implementation reference.
- [`guardrails/cross-industry/pii-tr`](https://github.com/lokomotifai/lokomotif-kit/blob/main/modules/guardrails/cross-industry/pii-tr.yaml) — canonical PII spec.
