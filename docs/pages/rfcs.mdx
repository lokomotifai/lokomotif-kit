...
RFCs are how the Kit makes durable decisions in writing. They are required for changes that affect the schema, scope, or convention. The full process is in [`GOVERNANCE.md`](https://github.com/lokomotif-ai/lokomotif-kit/blob/main/GOVERNANCE.md).

## Index

| Number | Status | Title |
|---|---|---|
| [0001](https://github.com/lokomotif-ai/lokomotif-kit/blob/main/docs/rfcs/0001-phase-6-partial-scope.md) | Accepted | Phase 6 partial scope — public-sourced canonical modules first |
