...
The `body` content depends on `kind`. The table below is a reference; the canonical specification lives in [`packages/schema/schemas/module.schema.json`](https://github.com/lokomotif-ai/lokomotif-kit/blob/main/packages/schema/schemas/module.schema.json).
